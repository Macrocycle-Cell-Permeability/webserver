  ...
  series: [
    {
      ...
      type: 'bar',
      barWidth: '60%',
      data: ['0', '0', '9', '129', '81', '41', '19', '13', '0', '1', '0', '0', '8', '0','4'],
    }
  ]
};
myChart.setOption(option);
  ...
  series: [
    {
      ...
      type: 'bar',
      barWidth: '60%',
      data: ['4', '227', '21', '14', '27', '5', '2','2','2','0','0','0','1'],
    }
  ]
};
myChart.setOption(option);
  ...
  series: [
    {
      ...
      type: 'bar',
      barWidth: '60%',
      data: ['1','0','10', '59', '130', '64', '18', '18', '5', '0'],
    }
  ]
};
myChart.setOption(option);
  ...
  series: [
    {
      ...
      type: 'bar',
      barWidth: '60%',
      data: ['17', '187', '35', '9', '23', '5', '18', '5', '3', '0', '1', '0', '2'],
    }
  ]
};
myChart.setOption(option);
